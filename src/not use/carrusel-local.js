...
function Carrusellocal({ imageneslocal }) { 
  const [ImagenActual, setImagenActual] = useState(0);
  const cantidad = Array.isArray(imageneslocal) && imageneslocal.length > 0 ? imageneslocal.length : 0;


  if (!Array.isArray(imageneslocal) || cantidad === 0) {
...
return (
  <div className="container-carrusel">
    ...
    {imageneslocal.map((imagen, index) => (
      <div
